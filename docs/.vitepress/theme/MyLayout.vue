  ...
  <Layout>
    ...
    <template #doc-footer-before>
      <div class="info custom-block" style="margin-bottom: 14px">
        ...
        <p>
          对这篇文章还有疑问？ 点击
          <a href="https://gitee.com/mybatis-flex/mybatis-flex/issues/new" target="_blank">[这里]</a>
          发起提问。
        </p>
      </div>
    </template>
        ...
        <div class="content">
          <!-- <div class="banner">
            <a href="https://dromara.gitee.io/fast-request/" target="_blank">
              <img src="/assets/images/ad/fast-request-20230828.svg" style="width: 120px; height: 50px" />
            </a>
          </div> -->
          <!-- <div class="banner">
            <a href="https://www.5iot.com/source?key=flex" target="_blank"><img src="/assets/images/ad/iotlink_20240802.png" /></a>
          </div> -->
          <div class="banner">
            <a href="http://www.jpress.cn" target="_blank" style="height: 50px; background: rgb(247 247 247); width: 105px; color: #000; font-size: 18px">
              信创 CMS
            </a>
          </div>
          <!-- <div class="banner">
          ...
          <div class="banner">虚位以待</div>
          <div class="banner">虚位以待</div>
        </div>
        <div class="banner-bottom">
          <a href="https://www.orangeforms.com" target="_blank"><img src="/assets/images/ad/cd_20250620.jpg" data-expired="20250620" /></a>
        </div>
        <!-- <div class="banner-bottom">
          <a href="https://www.diboot.com/?from=mf" target="_blank"><img src="https://www.diboot.com/diboot_mf.png" data-expired="20250116" /></a>
        </div> -->
      </div>
    </template>
  </Layout>
